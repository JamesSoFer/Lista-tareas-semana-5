...
function appendTaskDOM(tarea) {
  ...
  //Cambios a mejorar, para el funcionamiento del boton y a trabajar
  //tengo varias soluciones pero esta en concreto eme parece que es la que podria mejorar
  //creando una funcion para remover el item creado.
  function remove(removeItem) {
  //insertaria funcion
  }
  //llamaria a la funcion y se eliminaria el item
